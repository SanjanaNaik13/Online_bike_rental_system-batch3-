...
public RegistrationModel(String email_id,String name, String ph_no,String location,String s_quest,String s_ans)
{
...
public RegistrationModel(String model, String pday_rent, String b_colour, int b_id) {
	super();
	this.model = model;
	this.pday_rent = pday_rent;
	this.b_colour = b_colour;
...
public RegistrationModel(String model, String pday_rent, String b_colour, String rent_type, String reg_number,
		String status, String category, String engine_cc,int b_id)
{
	this.model = model;
	this.pday_rent = pday_rent;
	this.b_colour = b_colour;
